...
struct AgentStruct
{
	...
	bool operator==(const AgentStruct& other)
	{
		return other.pAgent == pAgent && oldPos == other.oldPos;
	}
};
// --- Cell ---
// ------------
struct Cell
{
	...
	bool IsPosInCell(const Elite::Vector2 pos) const;

	// all the agents currently in this cell
	std::list<AgentStruct> agents;
